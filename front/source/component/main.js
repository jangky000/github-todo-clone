import { $, $All, fetch_get, fetch_post, fetch_delete} from '../utils/tools.js';
...
export default class {
    ...
    addEvent(){
        ...
        $All(".btn_addCardForm").forEach(e=>e.addEventListener('click', this.addCardFormHandler));
        $All(".btn_deleteColumn").forEach(e=>e.addEventListener('click', this.deleteColumnHandler));
    }
